...
class ReportGenConfig(object):
    ...
    CSS_PATH = os.path.join(TEMPLATES_DIR, "inspection-report-new.component.css")

    REPORTS_DIR = os.path.join(os.getcwd(), 'Generated_Reports')
    TEMP_DIR = os.path.join(os.getcwd(), 'temp')
    BHI_MAX_ROWS_PER_PAGE = 25
...
class AWSConfig(object):
    ...
    T_D_REPORTS_DIR = 'reports/bridge/inspection/{SurveyId}/{ReportName}.pdf'
    SOLAR_EXCEL_DIR = 'reports/bridge/inspection/{SurveyId}/{ReportName}.xlsx'
